...
#define STRAPPY_ASSISTANT_SETS_SCHEMA_VERSION 6
...
#define STRAPPY_ASSISTANT_SET_DATABASE_STUDY_SESSION_NAME "Database Study"
...
typedef struct strappy_assistant_set_profile {
  ...
  char **skill_identifiers;
  size_t skill_identifier_count;
  char *preflight_when;
