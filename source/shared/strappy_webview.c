...
static const char *strappy_webview_answer_quality_label(
  const strappy_webview_labels *labels)
{
  if ((labels != NULL) && (labels->answer_quality != NULL) &&
      (labels->answer_quality[0] != '\0')) {
    return labels->answer_quality;
  }
  return "Answer Quality";
}

static const char *strappy_webview_passed_label(
  const strappy_webview_labels *labels)
{
  if ((labels != NULL) && (labels->passed != NULL) &&
      (labels->passed[0] != '\0')) {
...
static const char *strappy_webview_failed_label(
  const strappy_webview_labels *labels)
{
  if ((labels != NULL) && (labels->failed != NULL) &&
      (labels->failed[0] != '\0')) {
...
static const char *strappy_webview_not_applicable_label(
  const strappy_webview_labels *labels)
{
  if ((labels != NULL) && (labels->not_applicable != NULL) &&
      (labels->not_applicable[0] != '\0')) {
  ...
  const strappy_webview_labels *labels)
{
  ...
  if (strappy_webview_is_answer_quality_role(role)) {
                                         ...
                                         strappy_webview_palette palette)
{
  static const char * const chunks[] = {
    ...
    "box-sizing:border-box;color:#676268;text-align:center;line-height:1.3;}",
    ".layout{width:100%;}",
    ...
    "border:1px solid #a49da6;border-radius:17px;",
    "background:#f0edf2;color:#302e31;padding:0 42px 0 7px;",
    ...
    ".processing-autoscroll-on{background:#b9b2bc;border-color:#716a73;",
    "box-shadow:inset 0 1px 3px rgba(0,0,0,.2);color:#302e31;}",
    ".processing-status-retry_wait,.processing-status-retrying{",
    "border-color:#a49da6;background:#d7d1d9;color:#302e31;}",
    ".bubble,.reasoning,.tool-column,.response-metadata{box-shadow:none;}",
    ".tool-column{max-width:none;box-sizing:border-box;",
    "margin:0 -12px 10px;border:0;border-top:1px solid #a49da6;",
    "border-bottom:1px solid #a49da6;background:#d7d1d9;",
    "color:#302e31;padding:8px 12px;line-height:1.3;",
    ...
    "line-height:1.3;color:#676268;}",
    ".tool-column-toggle{color:#5d5262;text-decoration:none;}",
    ...
    ".processing-status-active .response-metadata-toggle{display:none;}",
    ...
    "box-sizing:border-box;border-top:1px solid #a49da6;}",
    ".row:first-child{border-top:0;}",
    ".row:last-child{margin-bottom:0;}",
    ".role{font-size:12px;font-weight:bold;color:#676268;margin:0 0 4px;}",
    ...
    ".prompt-group-toggle{color:#5d5262;text-decoration:none;}",
    ".prompt-group-hidden{display:none;}",
    ".prompt-group-harness{box-sizing:border-box;margin-left:8px;",
    "padding-left:10px;border-left:2px solid #a49da6;}",
    ...
    "border:0;border-top:1px solid #a49da6;border-bottom:1px solid #a49da6;",
    "background:#fff;padding:8px 12px;margin:0 -12px 10px;",
    "line-height:1.38;",
    "white-space:normal;word-wrap:break-word;}",
    ".assistant .role{display:block;}",
    ".assistant .bubble{background:#fff;",
    "border-top-color:#a49da6;border-bottom-color:#a49da6;",
    "font-size:16px;line-height:1.45;}",
    ".bubble-status{color:#676268;font-style:italic;}",
    ".tool_call .role,.tool .role{color:#676268;}",
    ".tool_call .bubble,.tool .bubble{max-width:100%;box-sizing:border-box;",
    "white-space:pre-wrap;}",
    ".tool_call .bubble,.tool .bubble{background:#f0edf2;",
    "border-color:#a49da6;color:#302e31;}",
    ".api_call,.api_error{background:#f0edf2;}",
    ".api_call .role,.api_error .role{color:#302e31;}",
    ".response-status-toggle{color:#5d5262;text-decoration:none;}",
    ".response-status-summary{vertical-align:baseline;}",
    ".response-metadata-toggle{color:#5d5262;text-decoration:none;}",
    ".api_call .bubble,.api_error .bubble{font-size:12px;line-height:1.35;",
    "white-space:pre-wrap;color:#302e31;background:#f0edf2;",
    "border-top-color:#a49da6;border-bottom-color:#a49da6;}",
    ".api_reasoning .role,.api_function_call .role,",
    ".api_function_output .role,.api_item .role,",
    ".api_server_tool .role,.answer_quality .role{color:#302e31;}",
    ".api_item .bubble{background:#f0edf2;",
    "color:#302e31;border-top-color:#a49da6;",
    "border-bottom-color:#a49da6;}",
    ".api_reasoning .bubble,.api_function_call .bubble,",
    ".api_function_output .bubble,",
    ".api_server_tool .bubble,.answer_quality .bubble{",
    "background:#f0edf2;color:#302e31;border-top-color:#a49da6;",
    "border-bottom-color:#a49da6;",
    ...
    ".api-reasoning-body{white-space:pre-wrap;word-wrap:break-word;}",
    ...
    ".bash-terminal+.bash-terminal{margin-top:8px;}",
    ".bash-terminal-error{border:2px solid #9a3e47;}",
    ".bash-terminal-header{box-sizing:border-box;min-height:25px;",
    "padding:5px 8px;border-bottom:1px solid #837b86;",
    "background:#ddd8e0;color:#2a282b;font-size:11px;line-height:15px;",
    "font-weight:bold;white-space:nowrap;overflow:hidden;",
    "text-overflow:ellipsis;}",
    ".bash-terminal-error>.bash-terminal-header{",
    "border-bottom-color:#9a3e47;}",
    ".bash-terminal-statuses{float:right;margin-left:8px;}",
    ".bash-terminal-failed{color:#9a3e47;}",
    ".bash-terminal-truncated{color:#755a00;}",
    ".bash-terminal-failed+.bash-terminal-truncated{margin-left:8px;}",
    ".bash-terminal>.bash-terminal-text{box-sizing:border-box;margin:0;",
    "padding:10px 12px;border:0;background:#f7f5f8;color:#2a282b;",
    "font-family:Menlo,Monaco,'Courier New',monospace;",
    "font-size:12px;line-height:1.4;white-space:pre-wrap;",
    "word-wrap:break-word;overflow:auto;}",
    ".bash-terminal-prompt{color:#5d5262;font-weight:bold;}",
    ".tool-panel{line-height:1.3;",
    "white-space:normal;color:#302e31;}",
    ".tool-subtle{color:#676268;font-size:12px;}",
    ".tool-value{white-space:pre-wrap;word-wrap:break-word;}",
    ".tool-pill{display:inline-block;border:1px solid #a49da6;",
    "background:#f0edf2;padding:4px 6px;margin:0 4px 4px 0;",
    "color:#676268;}",
    ".tool-section{margin:8px 0 0;}",
    ".tool-kv{border-collapse:collapse;width:100%;}",
    ".tool-kv th,.tool-kv td{border-top:1px solid #a49da6;",
    "padding:4px 6px;text-align:left;vertical-align:top;}",
    ".tool-kv th{width:150px;color:#676268;font-weight:bold;",
    "background:#d7d1d9;}",
    ".tool-table-wrap{overflow:auto;margin:8px 0 0;",
    "border:1px solid #a49da6;background:#f0edf2;}",
    ".tool-panel>.tool-table-wrap:first-child{margin-top:0;}",
    ".tool-table{border-collapse:collapse;min-width:100%;}",
    ".tool-table th,.tool-table td{border:1px solid #a49da6;",
    "padding:4px 6px;text-align:left;vertical-align:top;}",
    ".tool-table th{background:#d7d1d9;color:#302e31;font-weight:bold;}",
    ".tool-toggle{display:inline-block;margin-top:8px;color:#5d5262;",
    "text-decoration:none;}",
    ".tool-raw{display:none;margin:8px 0 0;padding:8px;",
    "border:1px solid #a49da6;background:#f0edf2;overflow:auto;",
    "white-space:pre-wrap;color:#302e31;}",
    ...
    ".tool-card{border-top:1px solid #a49da6;margin:0;",
    ...
    "padding:4px 0;background:#f0edf2;color:#302e31;",
    ...
    ".answer-quality-check{padding:6px 0;border-top:1px solid #a49da6;}",
    ".answer-quality-check:first-child{padding-top:0;border-top:0;}",
    ".answer-quality-check:last-child{padding-bottom:0;}",
    ".answer-quality-check-line{display:flex;align-items:baseline;}",
    ".answer-quality-check-label{flex:1;font-weight:bold;}",
    ".answer-quality-check-status{flex:0 0 12px;width:12px;",
    "margin-right:8px;text-align:center;white-space:nowrap;",
    "font-weight:bold;}",
    ".answer-quality-check-failed .answer-quality-check-status{color:#9a3e47;}",
    ".answer-quality-check-detail{margin:3px 0 0 20px;color:#676268;}",
    ".tool-input-title{font-weight:bold;",
    "color:#676268;margin:8px 0 4px;}",
    ".tool-input-title:first-child{margin-top:0;}",
    ".tool-field{margin:0 0 8px;}",
    ".tool-field:last-child{margin-bottom:0;}",
    ".tool-output{margin-top:8px;border-top:1px solid #a49da6;",
    "padding-top:8px;}",
    ".tool-output-toggle{color:#5d5262;text-decoration:none;}",
    ...
    "border-left:3px solid #a49da6;color:#676268;}",
    ".bubble pre,.reasoning-body pre{margin:0 0 8px;padding:8px;",
    "border:1px solid #a49da6;",
    "background:#f0edf2;overflow:auto;white-space:pre-wrap;}",
    ...
    "border:1px solid #a49da6;padding:4px 6px;text-align:left;}",
    ".bubble th,.reasoning-body th{background:#d7d1d9;font-weight:bold;}",
    ".bubble a,.reasoning-body a{color:#8e1bcf;text-decoration:none;}",
    ".bubble a:active,.reasoning-body a:active{color:#7216a6;}",
    ...
    "border:0;border-top:1px solid #a49da6;border-bottom:1px solid #a49da6;",
    "background:#f0edf2;color:#302e31;padding:8px 12px;",
    ...
    ".reasoning-toggle{color:#5d5262;text-decoration:none;}",
    ...
    "border:0;background:#f0edf2;color:#302e31;padding:0 0 4px;",
    ...
    "font-size:12px;",
    "font-weight:bold;line-height:1.3;color:#302e31;",
    "padding:3px 0;background:#f0edf2;white-space:nowrap;",
    "overflow:hidden;text-overflow:ellipsis;}",
    ".response-metadata-collapsed{padding-bottom:0;}",
    ".response-metadata-collapsed>.response-metadata-body{display:none;}",
    ".response-metadata-body{white-space:pre-wrap;border:0;",
    "background:transparent;padding:2px 0 0;margin:0;}",
    ".user .role,.user .meta{text-align:left;}",
    ".user .role{background:#d7d1d9;color:#302e31;margin:0 -12px;",
    "padding:8px 12px;border-top:1px solid #a49da6;}",
    ...
    "text-align:left;color:#302e31;}",
    ".harness .role,.developer .role{background:#d7d1d9;color:#302e31;",
    "margin:0 -12px;",
    "padding:8px 12px;border-top:1px solid #a49da6;}",
    ".harness .bubble,.developer .bubble{background:#fff;border-top:0;",
    "border-bottom:0;padding-top:4px;font-size:16px;line-height:1.45;}",
    ".meta{font-size:12px;color:#676268;margin-top:4px;}",
    ".state-pending .bubble{opacity:.72;}",
    ".state-pending .status,.state-cancelled .status{color:#676268;}",
    ".state-error .bubble{border-top-color:#a49da6;",
    "border-bottom-color:#a49da6;background:#f0edf2;}",
    ".state-error .status{color:#302e31;font-weight:bold;}",
    ".status a{color:#8e1bcf;text-decoration:none;}",
    ...
    "top:0;height:1px;background:#716a73;pointer-events:none;",
    ...
    "border-bottom:1px solid #a49da6;background:#b9b2bc;",
    "color:#302e31;font-size:12px;font-weight:bold;line-height:1.3;}",
    ".api-exchange-toggle{color:#5d5262;text-decoration:none;}",
    ...
    ".api-exchange-item,.api-exchange-status{background:#f0edf2;}",
    ...
    "padding:3px 10px;background:#f0edf2;",
    "font-weight:bold;white-space:nowrap;overflow:hidden;",
    "text-overflow:ellipsis;}",
    ...
    ".api-exchange-item.answer_quality>.bubble{padding:0 10px;}",
    ".api-exchange-item.api_reasoning>.bubble.tool-card-open,",
    ...
    ".api-exchange-item.answer_quality>.bubble.tool-card-open{",
    "padding-bottom:4px;}",
    ...
    "margin:0;padding:0 0 4px;background:#f0edf2;}",
    ...
    "margin:0;padding:2px 0 0;border:0;background:transparent;}",
    ".api-exchange-status>.response-metadata{margin:0;}",
    ".api-exchange-section-label{margin:0 -10px;padding:4px 10px;",
    "font-size:12px;line-height:1.2;font-weight:bold;color:#302e31;",
    "background:#d7d1d9;}",
    ".api-exchange-row,.api-exchange-row *{color:#302e31;}",
    ".api-exchange-row>.role,",
    ".api-exchange-row>.response-status-section>.role{background:#f0edf2;}",
    ".api-exchange-row>.bubble,.api-exchange-row>.reasoning,",
    ".api-exchange-row>.response-status-section,",
    ".api-exchange-row>.response-metadata{background:#f0edf2;}",
    ".api-exchange-row>.tool-column{background:#f0edf2;}",
    ".api-exchange-row .tool-card-toggle{background:#f0edf2;}",
    ".api-exchange-row .tool-table-wrap,.api-exchange-row .tool-pill,",
    ".api-exchange-row .tool-raw{background:#f0edf2;",
    "border-color:#a49da6;}",
    ".tool-column-error>.tool-rail-title,",
    ".tool-error>.tool-card-toggle{background:#e7c8cc;}",
    ".api-exchange-item>.tool-error>.tool-card-toggle{width:auto;",
    "margin-left:-10px;margin-right:-10px;",
    "padding-left:10px;padding-right:10px;}",
    ".tool-column-error>.tool-rail-title,",
    ".tool-column .tool-error>.tool-card-toggle{width:auto;",
    ...
    ".api-exchange-row .tool-subtle{color:#676268;}",
    ...
    ".api-exchange-row .status a{color:#8e1bcf;}",
    ".api-exchange-status.api_error>.response-status-section>.role,",
    ".api-exchange-status.state-error>.response-status-section>.role{",
    "background:#e7c8cc;}",
    ".api-exchange-status.api_error>.response-status-section>.bubble,",
    ".api-exchange-row .response-metadata-error,",
    ".api-exchange-row .response-metadata-warning{background:#f0edf2;",
    "color:#302e31;border-color:#a49da6;}",
    ".api-exchange-status.api_error>.response-status-section>.role,",
    ".api-exchange-status.api_error>.response-status-section>.bubble *,",
    ".api-exchange-row .response-metadata-error *,",
    ".api-exchange-row .response-metadata-warning *,",
    ".api-exchange-row.state-error>.status,",
    ".api-exchange-row.state-error>.status *{color:#302e31;}",
    ...
    ".api-exchange-row.assistant>.bubble *{color:#302e31;}",
    ".api-exchange-row.user>.bubble a,",
    ".api-exchange-row.harness>.bubble a,",
    ".api-exchange-row.developer>.bubble a,",
    ".api-exchange-row.assistant>.bubble a{color:#8e1bcf;}",
    ".api-exchange-row.user>.bubble a:active,",
    ".api-exchange-row.harness>.bubble a:active,",
    ".api-exchange-row.developer>.bubble a:active,",
    ".api-exchange-row.assistant>.bubble a:active{color:#7216a6;}",
...
#include "strappy_fontawesome_icons.inc"
    ...
    "function itemErrorIconHTML(label){return '<span class=\"tool-error-icon\" role=\"img\" ",
    "aria-label=\"'+escHTML(label||'Error')+'\">'+faIconHTML('solid','triangle-exclamation','!')+'</span>';}",
    "function toolErrorIconHTML(){return itemErrorIconHTML('Tool error');}",
    "function setItemTitle(n,text,error,label){if(n)n.innerHTML=",
    "(error?itemErrorIconHTML(label):'')+escHTML(text);}",
    ...
    "var strappyProcessingFinishAfterScrollGroup='';",
    "var strappyProcessingFinishAfterScrollRequested=0;",
    ...
    "else{e=firstByClass(e,'reasoning');if(e)setReasoningCollapsed(e,collapsed);}}}",
    ...
    "decorateAPIExchangesForRows(rowsForPromptGroup(group));decorateAPIToolGroupsForRows(rowsForPromptGroup(group));",
    "strappyProcessingStatusDirty=1;strappyProcessingNextTick=0;",
    "scheduleWebViewUpdate(0);}",
    "function beginProcessingFinishAfterScroll(group){if(group==='')return;",
    "strappyProcessingFinishAfterScrollGroup=group;",
    "strappyProcessingFinishAfterScrollRequested=0;}",
    "function finishProcessingStatusNow(){var group=strappyProcessingPromptGroupKey;",
    "strappyProcessingFinishAfterScrollGroup='';strappyProcessingFinishAfterScrollRequested=0;",
    "collapseAPIRoundsForPrompt(group);",
    "strappyProcessingStatus=null;syncProcessingInteractionState(0,group);",
    "decorateAPIExchangesForRows(rowsForPromptGroup(group));decorateAPIToolGroupsForRows(rowsForPromptGroup(group));",
    "clearProcessingStatusNode();strappyProcessingStatusDirty=0;strappyProcessingNextTick=0;}",
    "function completeProcessingFinishAfterScroll(){var group;",
    "if(!strappyProcessingFinishAfterScrollRequested)return;",
    "group=strappyProcessingFinishAfterScrollGroup;",
    "strappyProcessingFinishAfterScrollGroup='';strappyProcessingFinishAfterScrollRequested=0;",
    "if(group===''||group!==strappyProcessingPromptGroupKey)return;",
    "finishProcessingStatusNow();}",
    "function clearProcessingStatus(){var group=strappyProcessingPromptGroupKey;",
    "if(group!==''&&group===strappyProcessingFinishAfterScrollGroup){",
    "strappyProcessingFinishAfterScrollRequested=1;",
    "strappyProcessingStatus=null;strappyProcessingStatusDirty=0;strappyProcessingNextTick=0;",
    "if(strappyUpdateTimer!==null){clearTimeout(strappyUpdateTimer);strappyUpdateTimer=null;}",
    "strappyUpdateDue=0;removeProcessingStatusNode();",
    "if(!strappyAutoScrollEnabled||(strappyBatchDepth===0&&strappyScrollAnimationTimer===null))",
    "completeProcessingFinishAfterScroll();return;}finishProcessingStatusNow();}",
    "function removeProcessingStatusNode(){var n=byId('processing-status');",
    "if(n&&n.parentNode)n.parentNode.removeChild(n);}",
    "function clearProcessingStatusNode(){",
    ...
    "var slot=firstByClass(n[i],'response-metadata-error-slot');var parsed,status;",
    "if(!raw||!body)continue;try{parsed=parseMetadata(raw);status=metadataFinishStatus(parsed);",
    "setClass(n[i],'response-metadata-error',status=='error');setClass(n[i],'response-metadata-warning',status=='warning');",
    "if(slot)slot.innerHTML=status=='error'?itemErrorIconHTML('Response metadata error'):'';setNodeText(body,formatResponseMetadata(parsed));}",
    "catch(e){if(slot)slot.innerHTML='';setNodeText(body,raw);}}}",
    ...
    "function formatCumulativeWaitDuration(value){return value!==''?value:'';}",
    ...
    "function setRoundContextInclusion(id,included,animated){var rows;var targets=[];var i,row,value;",
    "id=jsonText(id);included=included?1:0;if(!(/^[1-9][0-9]*$/).test(id))return;",
    "rows=rowsForRound(id);",
    ...
    "decorateAPIExchangesForRows(rows);decorateAPIToolGroupsForRows(rows);decoratePromptGroupsForRows(rows);}",
    ...
    "rows=rowsForPromptGroup(group);seen={};for(i=0;i<rows.length;i++){id=apiRoundId(rows[i]);",
    ...
    "if(attempt==='1')return label;return label+' \\u00b7 '+attemptLabel+' '+attempt;}",
    ...
    "setItemTitle(summary,responseStatusSummary(row),rowIsAPIExchangeError(row),'Response error');",
    "role.appendChild(summary);setRowClass(row,'response-status-collapsed',collapsed);}",
    ...
    "if(cumulativeUsageCost!==''){cost=document.createElement('span');cost.className='api-exchange-turn-metric api-exchange-turn-cost';",
    ...
    "if(cumulativeWaitDuration!==''){wait=document.createElement('span');wait.className='api-exchange-turn-metric api-exchange-turn-wait';",
    "wait.innerHTML=faIconHTML('solid','hourglass-half','Wall time')+escHTML(formatCumulativeWaitDuration(cumulativeWaitDuration));",
    "metrics.appendChild(wait);}if(cumulativeUsageCost!==''||cumulativeWaitDuration!=='')h.appendChild(metrics);",
    "if(!active){h.className+=' disclosure-title';a=document.createElement('a');",
    ...
    "function moveResponseStatusBeforeAnswer(statusRow,responseRows){var parent,answer,last,next,i;if(!statusRow||!responseRows.length)return;",
    "parent=statusRow.parentNode;answer=null;for(i=0;i<responseRows.length;i++){if(rowIsAPIExchangeAnswer(responseRows[i])){answer=responseRows[i];break;}}",
    "if(answer){if(!parent||answer.parentNode!==parent||answer===statusRow||answer.previousSibling===statusRow)return;parent.insertBefore(statusRow,answer);return;}",
    "last=responseRows[responseRows.length-1];if(!parent||last.parentNode!==parent||last===statusRow)return;",
    ...
    "function refreshAPIExchangeGroupRows(g){var rows=rowsForRound(g.id);var out=[];var i,row;for(i=0;i<rows.length;i++){row=rows[i];",
    "if(apiRoundId(row)==g.id&&(rowIsResponseStatus(row)||rowIsAPIExchangeItem(row)))out[out.length]=row;}g.rows=out;}",
    "function moveResponseStatusesBeforeAnswers(g){var keys=g.attemptKeys;var i,attempt;for(i=0;i<keys.length;i++){",
    "attempt=g.attempts[keys[i]];moveResponseStatusBeforeAnswer(attempt.statusRow,attempt.responseRows);}refreshAPIExchangeGroupRows(g);",
    "indexAPIExchangeGroup(g);}",
    "function decorateAPIExchangesForRows(seedRows){var rows,groups={};var keys=[];var seen={};var i,j,k,row,id,roundId,key,g,anchor,collapsed,last,d;",
    "var answer,conversation,active,attempt,attemptKeys,attemptRows,statusRow,responseRows,attemptStartRow,context;",
    "for(i=0;i<seedRows.length;i++){roundId=apiRoundId(seedRows[i]);if(roundId===''||seen[indexKey(roundId)])continue;",
    "seen[indexKey(roundId)]=1;rows=rowsForRound(roundId);key=indexKey(roundId);",
    "groups[key]={id:roundId,promptKey:'',rows:[],requestRows:[],attempts:{},attemptKeys:[]};keys[keys.length]=key;",
    "for(k=0;k<rows.length;k++){row=rows[k];removeAPIExchangeDecoration(row);removeAPIExchangeTurnHeader(row);",
    "if(!rowIsResponseStatus(row)&&!rowIsAPIExchangeItem(row))continue;if(groups[key].promptKey==='')groups[key].promptKey=promptGroupKey(row);",
    "groups[key].rows[groups[key].rows.length]=row;}}",
    "for(i=0;i<keys.length;i++){g=groups[keys[i]];indexAPIExchangeGroup(g);moveResponseStatusesBeforeAnswers(g);",
    ...
    "if(statusRow)decorateResponseStatusRow(statusRow);",
    ...
    "rows=rowsForRound(id);decorateAPIExchangesForRows(rows);decorateAPIToolGroupsForRows(rows);decoratePromptGroupsForRows(rows);return false;}",
    "function toggleResponseStatus(a){var id=a&&a.getAttribute?a.getAttribute('data-api-call-id'):'';var row=a;var current,rows;",
    ...
    "rows=rowsForAPICall(id);decorateAPIExchangesForRows(rows);decorateAPIToolGroupsForRows(rows);decoratePromptGroupsForRows(rows);return false;}",
    ...
    "function decoratePromptGroupsForRows(seedRows){var keys=[];var seen={};var i,j,k,row,g,collapsed,anchor;",
    "for(i=0;i<seedRows.length;i++){k=promptGroupKey(seedRows[i]);if(k!==''&&!seen[indexKey(k)]){seen[indexKey(k)]=1;keys[keys.length]=k;}}",
    "for(i=0;i<keys.length;i++){k=keys[i];g=rowsForPromptGroup(k);for(j=0;j<g.length;j++){row=g[j];removePromptGroupToggle(row);",
    "setRowClass(row,'prompt-group-hidden',0);setRowClass(row,'prompt-group-collapsed-anchor',0);",
    "setRowClass(row,'prompt-group-harness',rowIsHarness(row));}collapsed=promptGroupCollapsed(k,g);anchor=promptGroupAnchor(g);",
    ...
    "for(j=0;j<g.length;j++)setRowClass(g[j],'prompt-group-hidden',collapsed&&rowIsHarness(g[j])&&g[j]!==anchor);}}",
    "function decoratePromptGroups(root){decoratePromptGroupsForRows(messageRows());}",
    ...
    "function toggleResponseMetadata(a){if(processingInteractionsLocked())return false;var box=a;while(box&&!hasClass(box,'response-metadata'))box=box.parentNode;",
    ...
    "if(v.type=='text'){if(typeof v.value!='undefined'){if(v.truncated)m[m.length]='truncated';",
    ...
    "if(typeof v.size_bytes!='undefined')m[m.length]=jsonText(v.size_bytes)+' bytes';",
    "if(v.invalid_utf8)m[m.length]='invalid UTF-8';if(v.contains_nul_bytes)m[m.length]='contains NUL bytes';",
    "if(v.omitted)m[m.length]='omitted';return '<span class=\"tool-subtle\">text'",
    "+(m.length?', '+escHTML(m.join(', ')):'')+'</span>';}",
    "return null;}",
    ...
    "return toolPanel(h.join(''),raw,o.ok===false?'tool-error':'');}",
    "function toolResultPanel(o,raw,name){if((name=='database_list'&&isArr(o))||(isObj(o)&&isArr(o.databases)))return databaseListHTML(o,raw);",
    "if(isObj(o)&&isArr(o.columns)&&isArr(o.rows))return queryHTML(o,raw);",
    "if(isObj(o)&&o.error)return toolPanel(",
    "'<div class=\"tool-value\">'+escHTML(jsonText(o.error))+'</div>'+toolObjectTable(o),raw,'tool-error');",
    "return toolPanel(toolJSONHTML(o),raw,'');}",
    ...
    "function bashTerminalHTML(label,text,error,truncated,prompt){var cls='bash-terminal'+(error?' bash-terminal-error':'');",
    "var statuses='';if(error)statuses+='<span class=\"bash-terminal-failed\">FAILED</span>';",
    "if(truncated)statuses+='<span class=\"bash-terminal-truncated\">TRUNCATED &middot; TAIL SHOWN</span>';",
    "return '<div class=\"'+cls+'\"><div class=\"bash-terminal-header\">'+",
    "(statuses!==''?'<span class=\"bash-terminal-statuses\">'+statuses+'</span>':'')+escHTML(label)+",
    "'</div><pre class=\"bash-terminal-text\">'+(prompt?'<span class=\"bash-terminal-prompt\">$ </span>':'')+",
    "escHTML(jsonText(text))+'</pre></div>';}",
    "function bashCommandBody(raw,error){var o=toolArgsValue(raw);var command=isObj(o)&&typeof o.command!='undefined'?",
    "jsonText(o.command):jsonText(o);if(command==='')command='(no command)';",
    "return bashTerminalHTML('COMMAND',command,error,0,1);}",
    "function bashOutputBody(raw,error){var o,text,truncated=0;if(!raw)",
    "return bashTerminalHTML('OUTPUT','Output pending',error,0,0);o=parseJSONSafe(raw);",
    "if(isObj(o)&&typeof o.output!='undefined'){text=jsonText(o.output);",
    "truncated=o.output_truncated===true||o.output_truncated===1;}",
    "else if(isObj(o)&&typeof o.error!='undefined')text=jsonText(o.error);else text=raw;",
    "return bashTerminalHTML('OUTPUT',text,error,truncated,0);}",
    "function toolOutputBody(raw,name,error){var o;if(name=='bash')return bashOutputBody(raw,error);",
    "if(!raw)return '<span class=\"tool-subtle\">Output pending</span>';",
    ...
    "error=apiToolHasError(row);if(isAPIToolCallRow(row)){raw=apiToolRaw(row,'arguments-json');",
    "body.innerHTML=name=='bash'?bashCommandBody(raw,error):toolPanel(toolInputBodyHTML(raw),raw,'');return;}",
    "raw=apiToolRaw(row,'result-json');body.innerHTML=toolOutputBody(raw,name,error);}",
    ...
    "if(!body||!data)return;name=jsonText(data.name||'Tool');if(name=='bash'){body.innerHTML=(data.outputOnly?'':",
    "bashCommandBody(data.args||'',data.error))+bashOutputBody(data.output||'',data.error);return;}",
    "body.innerHTML=(data.outputOnly?'':toolInputHTML(data.args||''))+toolOutputHTML(data.output,name,data.error);}",
    ...
    "function decorateAPIToolGroupsForRows(seedRows){var keys=[];var seen={};var rows;var i,j,row,key;",
    "for(i=0;i<seedRows.length;i++){row=seedRows[i];if(!isAPIToolCallRow(row)&&!isAPIToolOutputRow(row))continue;",
    "key=apiToolGroupKey(row);if(key!==''&&!seen[indexKey(key)]){seen[indexKey(key)]=1;keys[keys.length]=key;}}",
    "for(i=0;i<keys.length;i++){key=keys[i];rows=copyIndex(bucketRows(strappyAPIToolRowsByGroup,key));",
    "for(j=0;j<rows.length;j++)removeAPIToolGroupDecoration(rows[j]);",
    ...
    "var strappyMessageRowIndex=[];var strappyAssistantRowIndex=[];var strappyToolSourceRowIndex=[];",
    "var strappyAPIToolRowIndex=[];var strappyAPIServerToolRowIndex=[];var strappyAnswerQualityRowIndex=[];",
    "var strappyRowByMessageKeyIndex={};var strappyAssistantByMessageKeyIndex={};",
    "var strappyRowsByPromptGroup={};var strappyRowsByRound={};var strappyRowsByAPICall={};",
    "var strappyAPIToolRowsByCall={};var strappyAPIToolRowsByGroup={};var strappyToolRowsByTarget={};",
    "var strappyLastAssistantId='';var strappyPendingToolRows=[];var strappyMessageIndexesReady=0;",
    "function indexKey(v){return '$'+jsonText(v);}",
    "function copyIndex(a){var out=[];var i;if(!a)return out;for(i=0;i<a.length;i++)out[out.length]=a[i];return out;}",
    "function indexRemove(a,row){var i;if(!a)return;for(i=a.length-1;i>=0;i--){if(a[i]===row)a.splice(i,1);}}",
    "function indexAddBefore(a,row,before){var i;if(!a)return;",
    "if(before){for(i=0;i<a.length;i++){if(a[i]===before){a.splice(i,0,row);return;}}}a[a.length]=row;}",
    "function bucketRows(map,key){return key===''?[]:(map[indexKey(key)]||[]);}",
    "function bucketAdd(map,key,row,before){var k,b;if(key==='')return;k=indexKey(key);b=map[k];",
    "if(!b){b=[];map[k]=b;}indexAddBefore(b,row,before);}",
    "function bucketRemove(map,key,row){var k,b;if(key==='')return;k=indexKey(key);b=map[k];",
    "if(!b)return;indexRemove(b,row);if(!b.length)delete map[k];}",
    "function indexRowIdentity(row){var key=rowMessageKey(row);if(key!=='')strappyRowByMessageKeyIndex[indexKey(key)]=row;",
    "if(isAssistantRow(row)){strappyAssistantRowIndex[strappyAssistantRowIndex.length]=row;",
    "if(key!=='')strappyAssistantByMessageKeyIndex[indexKey(key)]=row;}}",
    "function unindexRowIdentity(row){var key=rowMessageKey(row);if(key!==''&&strappyRowByMessageKeyIndex[indexKey(key)]===row)",
    "delete strappyRowByMessageKeyIndex[indexKey(key)];if(isAssistantRow(row)){indexRemove(strappyAssistantRowIndex,row);",
    "if(key!==''&&strappyAssistantByMessageKeyIndex[indexKey(key)]===row)delete strappyAssistantByMessageKeyIndex[indexKey(key)];",
    "if(strappyLastAssistantId==rowId(row))strappyLastAssistantId=strappyAssistantRowIndex.length?",
    "rowId(strappyAssistantRowIndex[strappyAssistantRowIndex.length-1]):'';}}",
    "function indexToolTarget(row){var target=toolTarget(row);if(isToolRow(row)&&target!==''){",
    "bucketAdd(strappyToolRowsByTarget,target,row,null);row._strappyToolTargetIndexed=1;}}",
    "function unindexToolTarget(row){var target=toolTarget(row);if(isToolRow(row)&&row._strappyToolTargetIndexed){",
    "bucketRemove(strappyToolRowsByTarget,target,row);row._strappyToolTargetIndexed=0;}}",
    "function indexMessageRow(row,before){var key,round,call,group,target,i;if(!row||!hasClass(row,'row'))return;",
    "row._strappyIndexLocation='messages';row._strappyToolTargetIndexed=0;",
    "indexAddBefore(strappyMessageRowIndex,row,before);indexRowIdentity(row);",
    "key=promptGroupKey(row);round=apiRoundId(row);call=apiExchangeId(row);",
    "bucketAdd(strappyRowsByPromptGroup,key,row,before);bucketAdd(strappyRowsByRound,round,row,before);",
    "bucketAdd(strappyRowsByAPICall,call,row,before);",
    "if(isAPIToolCallRow(row)||isAPIToolOutputRow(row)){indexAddBefore(strappyAPIToolRowIndex,row,before);",
    "bucketAdd(strappyAPIToolRowsByCall,apiToolAttr(row,'tool-call-id'),row,before);",
    "group=apiToolGroupKey(row);bucketAdd(strappyAPIToolRowsByGroup,group,row,before);}",
    "if(isAPIServerToolRow(row))indexAddBefore(strappyAPIServerToolRowIndex,row,before);",
    "if(hasClass(row,'answer_quality'))indexAddBefore(strappyAnswerQualityRowIndex,row,before);",
    "if(isToolRow(row)){target=explicitToolTarget(row);if(target!=='')setToolTarget(row,target);",
    "else if(toolTarget(row)==='')strappyPendingToolRows[strappyPendingToolRows.length]=row;indexToolTarget(row);}",
    "if(isAssistantRow(row)){target=rowId(row);if(target!==''){strappyLastAssistantId=target;",
    "for(i=0;i<strappyPendingToolRows.length;i++)setToolTarget(strappyPendingToolRows[i],target);strappyPendingToolRows=[];}}}",
    "function unindexMessageRow(row,keepIdentity){if(!row)return;indexRemove(strappyMessageRowIndex,row);",
    "bucketRemove(strappyRowsByPromptGroup,promptGroupKey(row),row);bucketRemove(strappyRowsByRound,apiRoundId(row),row);",
    "bucketRemove(strappyRowsByAPICall,apiExchangeId(row),row);",
    "if(isAPIToolCallRow(row)||isAPIToolOutputRow(row)){indexRemove(strappyAPIToolRowIndex,row);",
    "bucketRemove(strappyAPIToolRowsByCall,apiToolAttr(row,'tool-call-id'),row);",
    "bucketRemove(strappyAPIToolRowsByGroup,apiToolGroupKey(row),row);}",
    "if(isAPIServerToolRow(row))indexRemove(strappyAPIServerToolRowIndex,row);",
    "if(hasClass(row,'answer_quality'))indexRemove(strappyAnswerQualityRowIndex,row);",
    "unindexToolTarget(row);indexRemove(strappyPendingToolRows,row);if(!keepIdentity)unindexRowIdentity(row);row._strappyIndexLocation='';}",
    "function indexToolSourceRow(row){if(!row||!isToolRow(row))return;row._strappyIndexLocation='tools';row._strappyToolTargetIndexed=0;",
    "indexRowIdentity(row);indexAddBefore(strappyToolSourceRowIndex,row,null);indexToolTarget(row);}",
    "function unindexToolSourceRow(row,keepIdentity){if(!row)return;indexRemove(strappyToolSourceRowIndex,row);",
    "unindexToolTarget(row);if(!keepIdentity)unindexRowIdentity(row);row._strappyIndexLocation='';}",
    "function unindexTimelineRow(row){if(!row)return;if(row._strappyIndexLocation=='tools')unindexToolSourceRow(row,0);",
    "else unindexMessageRow(row,0);}",
    "function messageRows(){return copyIndex(strappyMessageRowIndex);}",
    "function assistantRows(){return copyIndex(strappyAssistantRowIndex);}",
    "function rowsForPromptGroup(key){return copyIndex(bucketRows(strappyRowsByPromptGroup,key));}",
    ...
    "function setToolTarget(row,target){var old;if(!row||!target||!row.setAttribute)return;old=toolTarget(row);",
    "if(old==target)return;if(row._strappyToolTargetIndexed)bucketRemove(strappyToolRowsByTarget,old,row);",
    "row.setAttribute('data-tool-target',target);if(row._strappyToolTargetIndexed)bucketAdd(strappyToolRowsByTarget,target,row,null);}",
    "function toolTarget(row){return row&&row.getAttribute?row.getAttribute('data-tool-target')||'':'';}",
    "function flushPendingToolTargets(){var i;if(strappyLastAssistantId==='')return;",
    "for(i=0;i<strappyPendingToolRows.length;i++)setToolTarget(strappyPendingToolRows[i],strappyLastAssistantId);strappyPendingToolRows=[];}",
    "function assignToolTargetsFromMessageOrder(){flushPendingToolTargets();}",
    "function defaultToolTarget(){return strappyLastAssistantId;}",
    ...
    "v=toolRowSort(row);n=p.childNodes;for(i=0;i<n.length;i++){if(isToolRow(n[i])&&toolRowSort(n[i])>v){before=n[i];break;}}",
    "unindexMessageRow(row,1);if(before)p.insertBefore(row,before);else p.appendChild(row);indexToolSourceRow(row);}",
    "function moveToolRows(root){var rows=messageRows();var i;assignToolTargetsFromMessageOrder();",
    "for(i=0;i<rows.length;i++){if(isToolRow(rows[i]))insertToolSource(rows[i]);}}",
    "function moveToolRowsForRows(rows){var i;assignToolTargetsFromMessageOrder();",
    "for(i=0;i<rows.length;i++){if(isToolRow(rows[i]))insertToolSource(rows[i]);}}",
    "function toolSourceRows(){return copyIndex(strappyToolSourceRowIndex);}",
    "function initializeMessageIndexes(){var m=byId('messages');var p=toolSources();var n,i;",
    "strappyMessageRowIndex=[];strappyAssistantRowIndex=[];strappyToolSourceRowIndex=[];",
    "strappyAPIToolRowIndex=[];strappyAPIServerToolRowIndex=[];strappyAnswerQualityRowIndex=[];",
    ...
    "if(key=='session_rename')return answerQualityAttr(row,'session-named-label',jsonText(check.label));",
    "if(key=='fontawesome_confirm')return answerQualityAttr(row,'fontawesome-shortcode-confirmed-label',jsonText(check.label));",
    ...
    "function renderAnswerQualityRows(rows){rows=rows||answerQualityRows();var i,j,row,data,checks,check,status,label,detail,",
    "passed,failed,skipped,error,bubble,body,summary,h,summaryText,statusText,statusIcon;",
    "for(i=0;i<rows.length;i++){row=rows[i];if(!hasClass(row,'answer_quality'))continue;data=parseJSONSafe(answerQualityAttr(row,'answer-quality-json',''));",
    ...
    "h[h.length]='<div class=\"answer-quality-check'+((status=='failed'||status=='error')?' answer-quality-check-failed':'')+'\">'",
    "+'<div class=\"answer-quality-check-line\"><span class=\"answer-quality-check-status\" role=\"img\" aria-label=\"'+escHTML(statusText)+'\">'+statusIcon+'</span>'",
    "+'<span class=\"answer-quality-check-label\">'+escHTML(label)+'</span></div>'",
    "+(detail!==''?'<div class=\"answer-quality-check-detail\">'+escHTML(detail)+'</div>':'')+'</div>';}",
    "error=(isObj(data)&&jsonText(data.outcome)!='passed')||failed>0;",
    "bubble=firstByClass(row,'bubble');body=bubble?firstByClass(bubble,'tool-card-body'):null;summary=bubble?firstByClass(bubble,'tool-card-summary'):null;",
    "summaryText=answerQualityAttr(row,'answer-quality-label','Answer Quality');",
    ...
    "for(i=0;i<rows.length;i++){row=rows[i];if(row&&row.parentNode){renderMarkdown(row);renderResponseMetadata(row);}}",
    "renderToolsForRows(rows);renderAnswerQualityRows(rows);decorateAPIExchangesForRows(rows);",
    "decorateAPIToolGroupsForRows(rows);decoratePromptGroupsForRows(rows);",
    ...
    "function scrollBottomPosition(){var p=scrollHeight()-viewportHeight();return p>0?p:0;}",
    "function setScrollTopPosition(p){var b=document.body||{};var e=document.documentElement||{};",
    "if(e)e.scrollTop=p;if(b)b.scrollTop=p;window.scrollTo(0,p);}",
    "function cancelScrollBottomAnimation(){strappyScrollAnimationGeneration++;",
    "if(strappyScrollAnimationTimer!==null){clearTimeout(strappyScrollAnimationTimer);",
    "strappyScrollAnimationTimer=null;}}",
    "function scrollBottomNow(){cancelScrollBottomAnimation();",
    "setScrollTopPosition(scrollBottomPosition());completeProcessingFinishAfterScroll();}",
    "function scrollBottomAnimationStep(g,start,target,started){var now,progress,eased,p;",
    "if(g!=strappyScrollAnimationGeneration||!strappyAutoScrollEnabled){",
    "strappyScrollAnimationTimer=null;if(!strappyAutoScrollEnabled)",
    "completeProcessingFinishAfterScroll();return;}now=(new Date()).getTime();",
    "progress=(now-started)/strappyScrollAnimationDuration;if(progress>=1){",
    "setScrollTopPosition(target);strappyScrollAnimationTimer=null;",
    "completeProcessingFinishAfterScroll();return;}",
    "if(progress<0)progress=0;eased=1-Math.pow(1-progress,3);",
    "p=start+((target-start)*eased);setScrollTopPosition(Math.round(p));",
    "strappyScrollAnimationTimer=setTimeout(function(){",
    "scrollBottomAnimationStep(g,start,target,started);},16);}",
    "function scrollBottomAnimated(){var start,target,started,g;",
    "if(!strappyAutoScrollEnabled){completeProcessingFinishAfterScroll();return;}if(strappyBatchDepth>0){",
    "strappyBatchShouldScroll=1;return;}cancelScrollBottomAnimation();",
    "start=scrollTop();target=scrollBottomPosition();if(Math.abs(target-start)<1){",
    "setScrollTopPosition(target);completeProcessingFinishAfterScroll();return;}started=(new Date()).getTime();",
    "g=strappyScrollAnimationGeneration;strappyScrollAnimationTimer=setTimeout(function(){",
    "scrollBottomAnimationStep(g,start,target,started);},0);}",
    /* Recognize a committed final answer before moving its detached rows. */
    "function rowsHaveResponseFunctionCall(rows,id){var i;if(id==='')return 0;",
    "for(i=0;i<rows.length;i++){if(apiRoundId(rows[i])==id&&apiExchangeDirection(rows[i])=='response'&&",
    "apiExchangeKind(rows[i])=='function_call')return 1;}return 0;}",
    "function processingFinalAnswerGroup(rows){var i,row,id,group,existing;if(!processingInteractionsLocked())return '';",
    "for(i=0;i<rows.length;i++){row=rows[i];if(!rowIsAPIExchangeAnswer(row))continue;id=apiRoundId(row);",
    ...
    "d=nodesFromHTML(html);group=processingFinalAnswerGroup(d.childNodes);",
    "while(d.firstChild){n=d.firstChild;id=rowId(n);key=rowMessageKey(n);",
    "if((key!==''&&rowByMessageKeyAny(key))||(id!==''&&byId(id))){d.removeChild(n);continue;}",
    "m.appendChild(n);if(hasClass(n,'row')){indexMessageRow(n,null);added[added.length]=n;}}if(!added.length)return;",
    "if(group!=='')beginProcessingFinishAfterScroll(group);",
  ...
  cJSON *tool_display_registry)
{
  ...
  render_api_reasoning_card = strappy_webview_is_api_reasoning_role(role);
  render_api_tool_card =
    render_api_reasoning_card ||
    strappy_webview_is_api_function_call_role(role) ||
    strappy_webview_is_api_function_output_role(role) ||
  ...
  if (ok && strappy_webview_is_answer_quality_role(role)) {
    ok = strappy_webview_append_database_display_data_attribute(
         ...
         strappy_webview_append_data_attribute(
           &buffer,
           "passed-label",
           strappy_webview_passed_label(labels)) &&
         strappy_webview_append_data_attribute(
           &buffer,
           "failed-label",
           strappy_webview_failed_label(labels)) &&
         strappy_webview_append_data_attribute(
           &buffer,
  ...
  if (ok && render_api_tool_card) {
    ...
    if (ok && render_api_reasoning_card) {
      ok = strappy_webview_buffer_append_cstring(
        &buffer,
        " api-reasoning-card");
    }
  ...
  if (ok && render_bubble_status) {
    ...
    ok = ok && strappy_webview_buffer_append_cstring(&buffer, "\">");
    if (ok && render_api_reasoning_card) {
      ok = strappy_webview_append_database_display_text_html(
        &buffer,
        text,
        database_display_names,
        database_display_name_count,
  ...
  strappy_webview_palette palette)
{
  ...
  ok = ok &&
       ...
       strappy_webview_buffer_append_cstring(
         ...
         "</div></div><script>initializeMessageIndexes();"
