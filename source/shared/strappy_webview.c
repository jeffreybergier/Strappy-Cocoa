...
#include "strappy_fontawesome_icons.inc"
    ...
    "n._strappyMarkdown+=q.text;if(shouldRenderMarkdownReasoning(n))renderMarkdownNode(n);",
    ...
    "function appendMessageText(id,t){var r=byId(id);var b,stick=shouldAutoScroll();if(!r)return;",
    ...
    "else b.innerHTML=b._strappyMarkdown;scrollBottom(stick);}",
