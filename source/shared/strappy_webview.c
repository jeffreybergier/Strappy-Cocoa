...
static int strappy_webview_append_styles(strappy_webview_buffer *buffer)
{
  static const char * const chunks[] = {
    ...
    ".tool-column{max-width:100%;box-sizing:border-box;margin:0 0 8px;",
    "border:1px solid #cbd7e2;background:#f7fbff;color:#4d6478;",
    "padding:8px 12px;line-height:1.3;white-space:pre-wrap;word-wrap:break-word;}",
    ...
    ".tool-rail-title{font-weight:bold;",
    "line-height:1.3;color:#4d6478;margin:0 0 4px;}",
    ...
    ".prompt-group-harness{box-sizing:border-box;margin-left:16px;",
    "padding-left:12px;border-left:2px solid #d7caeb;}",
    ...
    "background:#fff;padding:8px 12px;line-height:1.3;",
    ...
    ".tool-card-toggle{display:block;padding:4px 6px;color:#2f4150;",
    "text-decoration:none;font-weight:bold;}",
    ".tool-card-summary{vertical-align:middle;}",
    ".tool-card-body{display:none;max-height:320px;overflow:auto;",
    "border:1px solid #e3e7ea;background:#fff;padding:8px;margin:4px 0 8px;}",
    ...
    "color:#4f4a36;padding:8px 12px;margin:0 0 8px;line-height:1.3;",
    "white-space:pre-wrap;word-wrap:break-word;}",
    ".reasoning-label{font-weight:bold;",
    ...
    "padding:8px 12px;margin:8px 0 0;line-height:1.3;",
    "white-space:pre-wrap;word-wrap:break-word;}",
    ".request-metadata-error{border-color:#d99;background:#fff7f7;color:#7a2525;}",
    ".request-metadata-error .request-metadata-title{color:#8a1f1f;}",
    ".request-metadata-warning{border-color:#caa85f;background:#fff9e8;color:#4d3d15;}",
