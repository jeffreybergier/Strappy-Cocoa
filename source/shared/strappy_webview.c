...
static int strappy_webview_append_styles(strappy_webview_buffer *buffer)
{
  static const char * const chunks[] = {
    ...
    "border-color:#959fa7;background:#c1c8ce;color:#30363b;}",
    ...
    ".api_server_tool .role,.answer_quality .role{color:#30363b;}",
    ".api_item .bubble{background:#dfe4e8;",
    ...
    ".bash-terminal-error{border:2px solid #d64242;}",
    ".bash-terminal-header{box-sizing:border-box;min-height:25px;",
    "padding:5px 8px;border-bottom:1px solid #225c2d;",
    "background:#0a130c;color:#86ff96;font-size:11px;line-height:15px;",
    ...
    ".bash-terminal-failed{color:#ff6b6b;}",
    ...
    "padding:10px 12px;border:0;background:#050805;color:#70ff83;",
    "font-family:Menlo,Monaco,'Courier New',monospace;",
    "font-size:12px;line-height:1.4;white-space:pre-wrap;",
    "word-wrap:break-word;overflow:auto;}",
    ".bash-terminal-prompt{color:#49d864;font-weight:bold;}",
    ...
    ".answer-quality-check{padding:6px 0;border-top:1px solid #959fa7;}",
    ...
    "font-weight:bold;}",
    ".answer-quality-check-failed .answer-quality-check-status{color:#8a1111;}",
    ".answer-quality-check-detail{margin:3px 0 0 20px;color:#606970;}",
    ...
    ".tool-error>.tool-card-toggle{background:#d99;}",
