...
static int strappy_webview_append_styles(strappy_webview_buffer *buffer)
{
  static const char * const chunks[] = {
    ...
    "border-bottom:1px solid #dbe8ef;background:#eef7fc;",
    "color:#334d60;padding:8px 12px;line-height:1.3;",
    "white-space:pre-wrap;word-wrap:break-word;}",
    ".tool-column-error{border-top-color:#d99;border-bottom-color:#e6b8c1;",
    "background:#fff2f5;color:#7a253f;}",
    ...
    "line-height:1.3;color:#36576d;margin:0 0 4px;}",
    ".tool-column-collapsed .tool-rail-title{margin-bottom:0;",
    "line-height:1.3;color:#2f4150;}",
    ...
    ".reasoning-disclosure,.metadata-disclosure{display:inline-block;width:12px;",
    ...
    ".load-more{display:block;margin:0 auto 16px;padding:8px;",
    "text-align:center;color:#2468a8;text-decoration:none;}",
    ".row{margin:0;padding:10px 12px 12px;clear:both;",
    "box-sizing:border-box;border-top:1px solid #e6e6e6;}",
    ".row:first-child{border-top:0;}",
    ".row:last-child{margin-bottom:0;}",
    ".role{font-size:12px;font-weight:bold;color:#777;margin:0 0 4px;}",
    ...
    "border:0;border-top:1px solid #e1e5e8;border-bottom:1px solid #edf0f2;",
    ...
    ".tool-subtle{color:#687887;font-size:12px;}",
    ...
    "padding:4px 6px;margin:0 4px 4px 0;color:#4d6478;}",
    ...
    ".tool-table-wrap{overflow:auto;margin:8px 0 0;border:1px solid #d8e0e7;background:#fff;}",
    ...
    ".tool-toggle{display:inline-block;margin-top:8px;color:#2468a8;",
    "text-decoration:none;}",
    ".tool-raw{display:none;margin:8px 0 0;padding:8px;border:1px solid #d8d8d8;",
    "background:#f8f8f8;overflow:auto;white-space:pre-wrap;color:#333;}",
    ...
    "border:1px solid #d8d8d8;padding:4px 6px;text-align:left;}",
    ...
    "border:0;border-top:1px solid #ecdfb9;border-bottom:1px solid #f1e8ca;",
    "background:#fff8e3;color:#4f4a36;padding:8px 12px;",
    "margin:0 -12px 10px;line-height:1.3;",
    "white-space:pre-wrap;word-wrap:break-word;}",
    ".reasoning-label{font-size:12px;font-weight:bold;",
    "line-height:1.3;color:#7a7046;margin:0 0 4px;}",
    ...
    "white-space:pre-wrap;word-wrap:break-word;}",
    ".request-metadata-error{border-top-color:#d99;border-bottom-color:#e5c2c2;",
    "background:#fff2f2;color:#7a2525;}",
    ".request-metadata-error .request-metadata-title{color:#8a1f1f;}",
    ".request-metadata-warning{border-top-color:#caa85f;border-bottom-color:#f1e8ca;",
    "background:#fff8e3;color:#4d3d15;}",
    ".request-metadata-warning .request-metadata-title{color:#6a4e0f;}",
    ".request-metadata-title{font-size:12px;font-weight:bold;",
    "color:#4d6478;margin:0 0 4px;}",
    ".request-metadata-toggle{color:#2468a8;text-decoration:none;margin-right:4px;}",
    ".request-metadata-summary{display:none;font-weight:normal;",
    "color:#687887;margin-left:8px;}",
    ...
    ".user .role{background:#eef5ff;color:#45627d;margin:0 -12px;",
    ...
    ".state-cancelled .status{color:#777;}",
